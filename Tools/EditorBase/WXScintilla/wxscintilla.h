...
//       and regenerate
    ...
    void MarkerDefineBitmap (int markerNumber, char const* const* xpmImage);
    ...
    void RegisterImage (int type, char const* const* xpmImage);
	...
	void SetLexerUserData (void* data);
...
// Others...
    ...
    bool LoadFile (const wxString& filename, bool deleteUndoHistory = true);
