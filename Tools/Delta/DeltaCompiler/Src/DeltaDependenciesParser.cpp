...
#define yylval  DeltaDependencies_yylval
#define yychar  DeltaDependencies_yychar
#define yydebug DeltaDependencies_yydebug
#define yynerrs DeltaDependencies_yynerrs
#define yylloc DeltaDependencies_yylloc
...
typedef union YYSTYPE { const std::string* str; const char* id; } YYSTYPE;
/* Line 196 of yacc.c.  */
...
static const yysigned_char yyrhs[] =
{
      ...
      -1,    15,    -1,    20,    -1,    -1,     5,    16,    17,    -1,
      18,    -1,    19,    -1,    21,     3,     8,    -1,     3,     8,
      -1,     9,     3,     8,    -1,    10,    -1,    20,    10,    -1,
       6,    -1,     3,     6,    -1,    21,     3,     6,    -1
};
...
{
       0,    57,    57,    57,    60,    60,    63,    63,    67,    66,
      72,    72,    75,    75,    78,    82,    82,    85,    86,    87
};
#endif
...
{
  "$end", "error", "$undefined", "IDENT", "STRING_CONST", "USING",
  "GLOBAL_SCOPE", "COLON", "SEMI", "STRINGIFY", "OTHER", "$accept",
  "DeltaCode", "CodeDefs", "CodeDef", "UsingDirective", "@1",
  "UsingSpecifications", "UsingNamespace", "UsingByteCodeLibrary", "Other",
  "NamespacePath", 0
};
#endif
...
{
       2,     8,    15,     0,     3,     5,     6,     7,     0,     1,
       4,    16,     0,    17,     0,     9,    10,    11,     0,    18,
      13,     0,     0,    14,    19,    12
};
...
{
      12,     9,    11,    13,     1,     0,    14,    21,    19,     2,
      20,    24,    22,    25,    23,    10
};

static const yysigned_char yycheck[] =
{
       3,     0,    10,     6,     5,    -1,     9,     3,     6,    10,
       8,     6,     3,     8,     8,     4
};
...
{
       0,     5,    10,    12,    13,    14,    15,    20,    16,     0,
      14,    10,     3,     6,     9,    17,    18,    19,    21,     6,
       8,     3,     3,     8,     6,     8
};
