...
Section "Core" SEC01
  ...
  WriteRegStr HKLM "Software\Sparrow\" "" "$INSTDIR"  
...
Section "Test Workspaces" SEC06
  ...
  SetOutPath "$INSTDIR\Workspaces\DeltaWxWidgets"
  ...
  File /r "..\..\Tools\Delta\DeltaExtraLibraries\XMLParser\lib\release\XMLParser.dll"
  File /r "..\..\Tools\Delta\DeltaExtraLibraries\wxWidgets\lib\release\WxWidgets.dll"
  SetOutPath "$INSTDIR\Workspaces\DeltaWxWidgets\cards"
  File /r "..\..\Tools\Delta\DeltaExtraLibraries\wxWidgets\sample\cards\*.png"

  SetOutPath "$INSTDIR\Workspaces\DeltaCORBA"
  ...
  SetOutPath "$INSTDIR\Workspaces\DeltaCORBA\bank"
  ...
  SetOutPath "$INSTDIR\Workspaces\DeltaCORBA\deferred"
  ...
  SetOutPath "$INSTDIR\Workspaces\DeltaCORBA\echo"
  ...
  SetOutPath "$INSTDIR\Workspaces\DeltaCORBA\generic"
  ...
  SetOutPath "$INSTDIR\Workspaces\DeltaUIGenerator\Src"
  File /r "..\..\Tools\Delta\DeltaTools\DeltaUIGenerator\Src\*.dsc"
  SetOutPath "$INSTDIR\Workspaces\DeltaUIGenerator\Project"
  File /r "..\..\Tools\Delta\DeltaTools\DeltaUIGenerator\Project\*.dproj"
  SetOutPath "$INSTDIR\Workspaces\DeltaUIGenerator\dbc"
  File /r "..\..\Tools\Delta\DeltaExtraLibraries\wxWidgets\lib\release\WxWidgets.dll"
  ...
  StrCpy $1 "$INSTDIR\Workspaces\DeltaUIGenerator\UIGenerator.wsp"
  Push $1
  Push "\"
  Call StrSlash
  Pop $1
  ...
  StrCpy $1 "$INSTDIR\Workspaces\DeltaCORBA\DeltaCorba.wsp"
  Push $1
  Push "\"
  Call StrSlash
  Pop $1
  ...
  StrCpy $1 "$INSTDIR\Workspaces\DeltaWxWidgets\sample_workspace.wsp"
  Push $1
  Push "\"
  Call StrSlash
  Pop $1
  ...
  StrCpy $1 "$INSTDIR\Workspaces\DeltaTests\Tests.wsp"
  Push $1
  Push "\"
  Call StrSlash
  Pop $1
...
;  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\Sparrow.exe"
