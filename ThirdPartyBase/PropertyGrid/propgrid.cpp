...
void wxPropertyContainerMethods::Remove( wxPGId id )
{
    wxPG_PROP_ID_CALL_PROLOG()
...
void wxPropertyGridState::DoRemove( wxPGProperty* item )
{
    wxCHECK_RET( item != &m_regularArray && item != m_abcArray,
        wxT("wxPropertyGrid: Do not attempt to remove the root item.") );
    ...
    // same as Delete but without actually deleting the item
