...
inline wxObject* wxPG_VariantToWxObject( wxVariant const& variant, wxClassInfo* classInfo )
{
...
public:
    ...
    */
    ...
    /** Override this member function to add custom behaviour on property deletion.
    */
    virtual void DoRemove( wxPGProperty* item );
...
public:
    ...
    */
    ...
    /** Removes a property by id. If category is deleted, all children are automatically deleted as well. */
    void Remove( wxPGId id );
