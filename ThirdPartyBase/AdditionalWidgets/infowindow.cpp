...
const wxColour titleBackground(96,96,96); // dark grey
const wxColour textBackground(250,250,250); // whitish
...
InfoWindow::InfoWindow(wxWindow* parent, const wxString& title, const wxString& message, unsigned int delay, unsigned int hysteresis)
            : wxInfoWindowBase(parent,
#if !wxUSE_POPUPWIN
...
// static
void InfoWindow::Display(wxWindow* parent, const wxString& title, const wxString& message, unsigned int delay, unsigned int hysteresis)
{
    ...
    //}
    new InfoWindow(parent, title, message, delay, hysteresis);
}
