...
class WXDLLIMPEXP_ADDITIONALWIDGETS wxTreeListItem;
class WXDLLIMPEXP_ADDITIONALWIDGETS wxTreeListHeaderWindow;
class WXDLLIMPEXP_ADDITIONALWIDGETS wxTreeListMainWindow;
...
class WXDLLIMPEXP_ADDITIONALWIDGETS wxTreeListColumnInfo: public wxObject {
